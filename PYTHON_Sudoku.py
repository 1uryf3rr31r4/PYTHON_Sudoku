...
def Linha_Escolhida(tableiro_data, y):
    linha_sorteada = tableiro_data[y]
    return linha_sorteada

def Coluna_Escolhida(tabuleiro_data, x):
    coluneta_sorteada = []
    for n in range(8):
        coluneta_sorteada.append(tabuleiro_data[n][x])
    return coluneta_sorteada
...
while True:
    ...
    mouse_position_x, mouse_position_y = mouse[0], mouse[1]
